...
export type UiAction =
 ...
 | { type: "OPEN_SOURCE_RANGE" | "HIGHLIGHT_SOURCE_RANGE"; node_id: string; start_line: number; end_line: number }
...
export type UiContext = { active_page: string; selected_node?: string; selected_feature?: string; selected_file?: string };
